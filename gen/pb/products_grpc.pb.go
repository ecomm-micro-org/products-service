...
type ProductsServiceClient interface {
	...
	GetProductsByIDs(ctx context.Context, in *GetProductsByIDsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetProductsByIDsResponse], error)
...
func (c *productsServiceClient) GetProductsByIDs(ctx context.Context, in *GetProductsByIDsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GetProductsByIDsResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &ProductsService_ServiceDesc.Streams[0], ProductsService_GetProductsByIDs_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type ProductsService_GetProductsByIDsClient = grpc.ServerStreamingClient[GetProductsByIDsResponse]
...
type ProductsServiceServer interface {
	...
	GetProductsByIDs(*GetProductsByIDsRequest, grpc.ServerStreamingServer[GetProductsByIDsResponse]) error
...
func (UnimplementedProductsServiceServer) GetProductsByIDs(*GetProductsByIDsRequest, grpc.ServerStreamingServer[GetProductsByIDsResponse]) error {
	return status.Error(codes.Unimplemented, "method GetProductsByIDs not implemented")
}
...
func _ProductsService_GetProductsByIDs_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetProductsByIDsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(ProductsServiceServer).GetProductsByIDs(m, &grpc.GenericServerStream[GetProductsByIDsRequest, GetProductsByIDsResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ProductsService_GetProductsByIDsServer = grpc.ServerStreamingServer[GetProductsByIDsResponse]
...
var ProductsService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "GetProductsByIDs",
			Handler:       _ProductsService_GetProductsByIDs_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "protos/proto/products.proto",
}
